...
class Config:
    ...
    # Market Data (yfinance is keyless; FRED key is free tier)
    FRED_API_KEY: str = os.getenv("FRED_API_KEY", "4b10e4313ff2d2784d439bee0bb58893")
    ALPHA_VANTAGE_API_KEY: Optional[str] = os.getenv("ALPHA_VANTAGE_API_KEY")  # optional fallback
